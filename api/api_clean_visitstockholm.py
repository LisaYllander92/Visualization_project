...
def clean():
    ...
    # Byt ut rename-delen, ta bort url-konflikten
    ...
    # Lägg till url manuellt för specifika event
    result.loc[result[
                   "name"] == "Empire of the Sun", "url"] = "https://www.livenation.se/event/empire-of-the-sun-stockholm-tickets-edp1648175"

    # Ta bort event som saknar url
